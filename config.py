...
ADMIN = ADMINS
DATABASE_NAME = os.environ.get("DATABASE_NAME", "bynkurl")
DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://clientstamil4k:ruban9124@cluster0.7cwdmdt.mongodb.net/?retryWrites=true&w=majority") 
